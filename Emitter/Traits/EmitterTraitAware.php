...
namespace Qubus\Http\Emitter\Traits;

use Psr\Http\Message\ResponseInterface;
use Qubus\Http\Emitter\Exceptions\HeadersAlreadySentException;
use Qubus\Http\Emitter\Exceptions\PreviousOutputException;
